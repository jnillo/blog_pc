defmodule Patricia.PostController do
  use Patricia.Web, :controller

  alias Patricia.Post
  alias Patricia.Comment
  ...
  def add_comment(conn, %{"comment" => comment_params, "post_id" => post_id}) do
    changeset = Patricia.Comment.changeset(%Patricia.Comment{}, Map.put(comment_params, "post_id", post_id))
